...
class HAInspectorStatusSensor(SensorEntity):
    ...
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self._result: dict[str, Any] | None = hass.data.get(DOMAIN, {}).get(
            DATA_LAST_RESULT
        )
        self._update_from_result(self._result)

    @callback
    def _update_from_result(self, result: dict[str, Any] | None) -> None:
        """Update native value and attributes from an inspection result."""
        self._result = result
    ...
    @callback
    def _handle_inspection_finished(self, result: dict[str, Any]) -> None:
