...
class InspectionResult:
    ...
    resolved_remediation_items: tuple[ResolvedRemediationItem, ...] = field(
        default_factory=tuple
    )
    ...
    def record_rule(
        ...
        *,
        ...
        self.category_checks[category] = (
            self.category_checks.get(category, 0) + 1
        )
    ...
    def domain_health(self) -> dict[str, dict[str, Any]]:
        """Return health summaries for primary user-facing domains."""
    ...
    def as_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "resolved_remediation_items": self.resolved_remediation_items,
